...
public class AllStudentLeaved extends javax.swing.JFrame {

    
    public AllStudentLeaved() {
        initComponents();
        loadLeavedStudents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ALL STUDENT LEAVED");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "INDEX", "NAME", "CONTACT NUMBER", "room number"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllStudentLeaved.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void loadLeavedStudents(){
         ...
         NewStudetDao dao = new NewStudetDao();
         ArrayList<NewStudentDetails> leavedStudents = dao.getAllLeavedStudents();
         for (NewStudentDetails student : leavedStudents) {
